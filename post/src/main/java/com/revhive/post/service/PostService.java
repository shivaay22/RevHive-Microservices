package com.revhive.post.service;
import com.revhive.post.UserClient;
import com.revhive.post.dto.response.UserResponse;
import com.revhive.post.model.Post;
import com.revhive.post.repository.PostRepository;
...
public class PostService {
    ...
    private Post validatePostOwnership(
            Long postId,
            Long userId
    ) {
        ...
        if (!Objects.equals(post.getUserId(), userId)) {
            ...
            logger.warn(
                    "User ID: {} not authorized to access post ID: {}",
                    userId,
                    postId
            );

            throw new RuntimeException(
                    "User not authorized to perform this action on post ID: "
                            + postId
            );
        }
